...
public class MailSenderService {
    ...
    // 가입할 회원에서 전송할 이메일 양식 준비
    // userService가 이 메서드를 호출
    public String joinMail(String email) throws MessagingException {
        int authNum = makeRandomNumber();
        String setFrom = "kimjiah045022@gmail.com"; // 발신용 이메일 주소 (yml과 동일하게)
//        String setFrom = "fresh04502@naver.com"; // 발신용 이메일 주소 (yml과 동일하게)
